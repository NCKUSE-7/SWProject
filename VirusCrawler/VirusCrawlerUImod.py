...
class Flight(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        #json_file = open("C:/Users/user/PycharmProjects/SWProject/VirusCrawler/fi_out.json", "r", encoding='utf-8')
        #json_data=json_file.readlines()
        file_path="C:/Users/user/PycharmProjects/SWProject/VirusCrawler/fi_out.json"
        self.FData = json.load(open(file_path,encoding='utf-8'))
        print(self.FData)
        print(type(self.FData))
        #self.FData = json.loads(json_data[0], encoding='utf-8')
        #self.FData = json_data[0]
        #json_file.close()
        ...
        self.ui.main.clicked.connect(self.goBackToStartup)
        self.ui.search.hide()
